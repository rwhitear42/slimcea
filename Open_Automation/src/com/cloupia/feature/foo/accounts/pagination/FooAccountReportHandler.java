package com.cloupia.feature.foo.accounts.pagination;
 ...
 *
 */
public class FooAccountReportHandler extends PaginatedReportHandler {

	static Logger logger = Logger.getLogger(FooAccountReportHandler.class);
