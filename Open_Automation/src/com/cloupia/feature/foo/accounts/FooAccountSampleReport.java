 ...
 *
 */
public class FooAccountSampleReport extends CloupiaReportWithActions {
	
	private static final String NAME = "foo.account.sample.report";
	private static final String LABEL = "Foo Account Sample";
	
	public FooAccountSampleReport() {
		super();
	...
	public Class getImplementationClass() {
		...
		return FooAccountSampleReportImpl.class;
	}
