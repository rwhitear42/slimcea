...
import com.cloupia.feature.foo.pojo.EmailMessageRequest;
import com.cloupia.feature.foo.util.MailManager;
...
public class EmailDatacentersTask extends AbstractTask
{
    ...
    public void executeCustomAction(CustomActionTriggerContext context, CustomActionLogger actionLogger) throws Exception
    {
       ...
       // List<DataCenter> dcs = InfraPersistenceUtil.getDataCenterList();
        ...
        try
        {
            context.saveOutputValue(FooConstants.EMAIL_TASK_OUTPUT_NAME, toAddresses);
