{
      jars:  [ 	"features/feature-slimcea.jar", 
      			"features/slimcea/lib/jsch/jsch-0.1.45.jar", 
      			"features/slimcea/lib/apache-commons-httpclient/httpclient-4.5.1.jar", 
      			...
      			"features/slimcea/lib/nimblerest-rwhitear/nimblerest-rwhitear-1.0.9j.jar" ],
