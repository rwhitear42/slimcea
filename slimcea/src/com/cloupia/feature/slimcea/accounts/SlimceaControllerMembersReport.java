 ...
 *
 */
public class SlimceaControllerMembersReport extends CloupiaReportWithActions {
	
	private static final String NAME = "slimcea.controller.members.report";
	private static final String LABEL = "Controller Members";
	
	public SlimceaControllerMembersReport() {	
		super();		
	...
	public Class getPaginationModelClass() {
		...
		return SlimceaControllerMembersAccountReport.class;
	}
