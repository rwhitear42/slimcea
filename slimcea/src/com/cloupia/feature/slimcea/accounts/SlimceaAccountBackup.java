...
@PersistenceCapable(detachable = "true", table = "slimcea_account_backup")
public class SlimceaAccountBackup extends AbstractInfraAccount implements
ConnectorCredential {

static Logger logger = Logger.getLogger(SlimceaAccountBackup.class);
...
try {
	...
	/*else if (deviceCategory.equalsIgnoreCase("slimcea Account")) {
