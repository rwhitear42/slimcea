 ...
 *
 */
public class SlimceaInitiatorGroupsReport extends CloupiaReportWithActions {
	
	private static final String NAME = "slimcea.initiator.groups.report";
	private static final String LABEL = "Initiator Groups";
	
	public SlimceaInitiatorGroupsReport() {	
		super();		
