...
@PersistenceCapable(detachable = "true", table = "slimcea_account")
public class SlimceaAccount extends AbstractInfraAccount implements
		ConnectorCredential {

	static Logger logger = Logger.getLogger(SlimceaAccount.class);
