 ...
 *
 */
public class SlimceaPerformancePoliciesReport extends CloupiaReportWithActions {
	
	private static final String NAME = "slimcea.performance.policies.report";
	private static final String LABEL = "Performance Policies";
	
	public SlimceaPerformancePoliciesReport() {	
		super();		
