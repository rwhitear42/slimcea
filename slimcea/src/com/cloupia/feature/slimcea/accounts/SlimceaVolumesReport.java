 ...
 *
 */
public class SlimceaVolumesReport extends CloupiaReportWithActions {
	
	private static final String NAME = "slimcea.volumes.report";
	private static final String LABEL = "Volumes";
	
	public SlimceaVolumesReport() {
		super();
	...
	public Class getImplementationClass() {
		...
		return SlimceaVolumesReportImpl.class;
	}
