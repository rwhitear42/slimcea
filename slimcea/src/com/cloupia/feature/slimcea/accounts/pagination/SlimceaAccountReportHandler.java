package com.cloupia.feature.slimcea.accounts.pagination;
 ...
 *
 */
public class SlimceaAccountReportHandler extends PaginatedReportHandler {

	static Logger logger = Logger.getLogger(SlimceaAccountReportHandler.class);
