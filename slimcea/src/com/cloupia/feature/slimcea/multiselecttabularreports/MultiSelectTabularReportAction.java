...
public class MultiSelectTabularReportAction extends CloupiaPageAction {
	...
	private static final String formId = "slimcea.multiselect.tabular.form";
	private static final String ACTION_ID = "slimcea.multiselect.tabular.action";
	...
	public int validatePageData(Page page, ReportContext context, WizardSession session) throws Exception {
		...
		// logger.info("Slimcea Slimcea Slimcea " + form.getName() + " : " +
		// form.getValue());
