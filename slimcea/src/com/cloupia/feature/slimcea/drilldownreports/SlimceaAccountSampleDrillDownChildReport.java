...
import com.cloupia.feature.slimcea.accounts.model.DummyVLAN;
 ...
 *
 */
public class SlimceaAccountSampleDrillDownChildReport extends
		CloupiaEasyDrillableReport {
	static Logger logger = Logger.getLogger(SlimceaAccountSampleDrillDownChildReport.class);
	...
	public SlimceaAccountSampleDrillDownChildReport(String name, String label,
			Class dbSource) {
	...
	public ContextMapRule[] getMapRules() {
		...
		DynReportContext dummyContextOneType = ReportContextRegistry
				.getInstance().getContextByName(
						SlimceaConstants.SLIMCEA_ACCOUNT_DRILLDOWN_NAME);
	...
	public Class getImplementationClass() {
		...
		// more details
		return null;// SlimceaAccountSampleReportImpl.class;
	}
	...
	public Class getPaginationProvider() {
		// TODO Auto-generated method stub
		return SlimceaAccountDrillDownReportHandler.class;
	}
