package com.cloupia.feature.slimcea.drilldownreports;
 ...
 *
 */
public class SlimceaAccountDrillDownReportHandler extends PaginatedReportHandler {

	static Logger logger = Logger.getLogger(SlimceaAccountDrillDownReportHandler.class);
	
	/*
	 * This method is used to get sub query.
	 * @return Query This returns Query(Ex:accountName= 'Test-Slimcea-Account')
	 */
	@Override
