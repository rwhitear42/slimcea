package com.cloupia.feature.slimcea.resourceComputer;

import java.util.List;

import org.apache.log4j.Logger;

import com.cloupia.feature.slimcea.actions.AssignDummyVLANToGroupForm;
...
public class DummyVLANResourceComputer implements ResourceCountComputerIf {
	...
	public double computeUsageByTenant(Group group) throws Exception {
		logger.info("SlimceaSlimcea computing resources for " + group.getGroupId());
		logger.info("SlimceaSlimcea computing resources for " + group.getGroupName());
