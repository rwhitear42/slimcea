package com.cloupia.feature.slimcea.menuProvider;
 ...
 * to note where in SlimceaModule.java this provider is being instantiated and registered!
 *
 */
public class DummyMenuProvider extends AbstractTreeNodesProviderIf {
	...
	public void registerWithProvider() {
		...
		UIMenuLHTreeProvider.getInstance().registerLHTreeNodeProvider( SlimceaConstants.DUMMY_MENU_1 , this );
	}
