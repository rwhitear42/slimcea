...
public class SlimceaConstants {
	...
	public static final String SLIMCEA_MY_FIRST_DROPDOWN = "slimcea.my.first.dropdown";
	public static final String SLIMCEA_MY_FIRST_DROPDOWN_LABEL = "Slimcea My First Dropdown Label";
