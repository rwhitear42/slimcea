...
@PersistenceCapable(detachable = "true", table = "slimcea_addinitiatortoigrouptask")
public class SlimceaAddInitiatorToIgroupConfig implements TaskConfigIf {

	public static final String displayLabel = "Nimble Add Initiator to Initiator Group";
	@Persistent
