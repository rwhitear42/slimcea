...
@PersistenceCapable(detachable = "true", table = "slimcea_slimceagetinventorytask")
public class SlimceaGetInventoryConfig implements TaskConfigIf {

	public static final String displayLabel = "Nimble Get Inventory";
	@Persistent
