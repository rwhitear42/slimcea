...
@PersistenceCapable(detachable = "true", table = "slimcea_assocvoltovolcollectiontask")
public class SlimceaAssocVolToVolumeCollectionConfig implements TaskConfigIf {
