...
@PersistenceCapable(detachable = "true", table = "slimcea_removefcinitiatorfromigrouptask")
public class SlimceaRemoveFcInitiatorFromIgroupConfig implements TaskConfigIf {

	public static final String displayLabel = "Nimble Remove Fibre Channel Initiator from Initiator Group";
	@Persistent
	...
	@FormField(label = "Nimble Initator Alias", help = "Enter Nimble Initator Alias", mandatory = true, type = FormFieldDefinition.FIELD_TYPE_TEXT)
	@UserInputField(type = SlimceaConstants.GENERIC_TEXT_INPUT)
	@Persistent
	private String             alias;

	public SlimceaRemoveFcInitiatorFromIgroupConfig() {

	}
	
	public SlimceaRemoveFcInitiatorFromIgroupConfig(SlimceaAddFcInitiatorToIgroupConfig config) {
