...
@PersistenceCapable(detachable = "true", table = "slimcea_slimceadeleteigrouptask")
public class SlimceaDeleteIgroupConfig implements TaskConfigIf {
	...
	public SlimceaDeleteIgroupConfig() {

	}
	
	public SlimceaDeleteIgroupConfig(SlimceaCreateIgroupConfig config) {
