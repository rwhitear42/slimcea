...
@PersistenceCapable(detachable = "true", table = "slimcea_enablesnmpnexustask")
public class EnableSNMPNexusConfig implements TaskConfigIf {

	public static final String displayLabel = "EnableSNMPNexusTask";
	@Persistent
