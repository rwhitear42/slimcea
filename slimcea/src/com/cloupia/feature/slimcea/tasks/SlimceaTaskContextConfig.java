...
@PersistenceCapable(detachable = "true", table = "slimcea_context_task")
public class SlimceaTaskContextConfig implements TaskConfigIf {

	public static final String displayLabel = "Slimcea Context Task";
	@Persistent
	...
	public SlimceaTaskContextConfig() {
