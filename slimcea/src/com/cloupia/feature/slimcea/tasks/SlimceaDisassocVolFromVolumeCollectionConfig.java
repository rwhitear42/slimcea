...
@PersistenceCapable(detachable = "true", table = "slimcea_disassocvolfromvolcolltask")
public class SlimceaDisassocVolFromVolumeCollectionConfig implements TaskConfigIf {

	public static final String displayLabel = "Nimble Disassociate Volume from Volume Collection";
	@Persistent
	...
	public SlimceaDisassocVolFromVolumeCollectionConfig(SlimceaAssocVolToVolumeCollectionConfig config) {
