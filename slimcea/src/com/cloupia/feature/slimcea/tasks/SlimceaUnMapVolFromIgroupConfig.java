...
@PersistenceCapable(detachable = "true", table = "slimcea_slimceaunmapvolfromigrouptask")
public class SlimceaUnMapVolFromIgroupConfig implements TaskConfigIf {

	public static final String displayLabel = "Nimble Unmap Volume from Initiator Group";
	@Persistent
	...
	public SlimceaUnMapVolFromIgroupConfig() {

	}
	
	public SlimceaUnMapVolFromIgroupConfig(SlimceaMapVolumeToIgroupConfig config) {
