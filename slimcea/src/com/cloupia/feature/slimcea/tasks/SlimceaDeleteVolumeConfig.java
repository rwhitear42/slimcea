...
@PersistenceCapable(detachable = "true", table = "slimcea_slimceadeletevolumetask")
public class SlimceaDeleteVolumeConfig implements TaskConfigIf {

	public static final String displayLabel = "Nimble Delete Volume";
	@Persistent
	...
	public SlimceaDeleteVolumeConfig() {

	}
	
	public SlimceaDeleteVolumeConfig(SlimceaCreateVolumeConfig config) {
