...
@PersistenceCapable(detachable = "true", table = "slimcea_removeiscsiinitiatorfromigrouptask")
public class SlimceaRemoveIscsiInitiatorFromIgroupConfig implements TaskConfigIf {

	public static final String displayLabel = "Nimble Remove ISCSI Initiator from Initiator Group";
	@Persistent
	...
	public SlimceaRemoveIscsiInitiatorFromIgroupConfig() {

	}
	
	public SlimceaRemoveIscsiInitiatorFromIgroupConfig(SlimceaAddIscsiInitiatorToIgroupConfig config) {
